    ...
    <div className={styles.headerContainer}>
      ...
      <div className={styles.logoAndMenu}>
        ...
        <div className={styles.menuList}>
          <HeaderMenu name="HOME" onClick={() => navigate("/home")} />
          <HeaderMenu
            name="UPCOMING"
          ...
          <HeaderMenu name="MORE" onClick={() => navigate("/home/notice")} />
        </div>
      </div>
          ...
          {isLoggedIn ? (
            <>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.98 }}
                onClick={handleNavigation} // userNum으로 마이페이지로 이동
              >
                {user.role == "admin" ? "Admin" : "My Page"}
              </motion.button>
            </>
          ) : (
            <>
