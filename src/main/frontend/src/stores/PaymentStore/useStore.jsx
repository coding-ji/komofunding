...
export const useStore = () => {
  ...
  const actions = {
    ...
    changeAccountHolder: (accountHolder) =>
      dispatch(changeAccountHolder(accountHolder)),
    ...
    changePaymentDate: (paymentDate) =>
      dispatch(changePaymentDate(paymentDate)),
    ...
    changeFailureReason: (failureReason) =>
      dispatch(changeFailureReason(failureReason)),
    changeSenderName: (senderName) => dispatch(changeSenderName(senderName)),
    changeShippingName: (shippingName) =>
      dispatch(changeShippingName(shippingName)),
    changeShippingPhone: (shippingPhone) =>
      dispatch(changeShippingPhone(shippingPhone)),
    changeShippingAddress: (shippingAddress) =>
      dispatch(changeShippingAddress(shippingAddress)),
    changeRefundBankName: (refundBankName) =>
      dispatch(changeRefundBankName(refundBankName)),
    changeRefundAccountHolder: (refundAccountHolder) =>
      dispatch(changeRefundAccountHolder(refundAccountHolder)),
    changeRefundAccountNumber: (refundAccountNumber) =>
      dispatch(changeRefundAccountNumber(refundAccountNumber)),
    ...
    createDonorByProject: (projectNum, payment) =>
      createDonorByProject(projectNum, payment)(dispatch),

    readDonorsByProjectNum: (projectNum) =>
      readDonorsByProjectNum(projectNum)(dispatch),

    getMyFundingByProject: (projectStatus) =>
      getMyFundingByProject(projectStatus)(dispatch),

    addPayment: (paymentNum, payment) =>
