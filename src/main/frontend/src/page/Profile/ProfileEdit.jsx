...
const ProfileEdit = () => {
  ...
  const handlePasswordCheck = async () => {
    try {
      ...
      const result = await userActions.apiVerifyPassword(
        userNum,
        data.password
      );
              ...
              <div className="profile-edit-form">
                ...
                <div className="flex-row">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      userActions.changeUserShortDescription(e.target.value)
                    }
                  />
                </div>
                ...
                <div className="flex-row">
                  ...
                  <Input
                    ...
                    name="phoneNumber"
                    onChange={(e) =>
                      userActions.changePhoneNumber(e.target.value)
                    }
                  />
                </div>
                ...
                <div className="flex-row">
                  ...
                  <select
                    ...
                    name="bankName"
                    onChange={(e) =>
                      userActions.changeUserBankName(e.target.value)
                    }
                  >
                  ...
                  <Input
                    ...
                    name="accountNum"
                    onChange={(e) =>
                      userActions.changeUserAccountNumber(e.target.value)
                    }
                    placeholder="계좌번호"
                  />
                  <Input
                    ...
                    name="accountName"
                    onChange={(e) =>
                      userActions.changeUserAccountHolder(e.target.value)
                    }
                    placeholder="계좌주"
                  />
                </div>
