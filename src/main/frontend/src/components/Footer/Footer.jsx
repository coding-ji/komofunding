            ...
            <div className={styles.wrapper1}>
                <div className={styles.menu1}>
                    ...
                    <ul className={{ fontSize: "15px"}}>
                            ...
                            <li className={styles.li}><Link to="/create" className={styles.linkcss}>창작 가이드</Link></li>
                ...
                <div className={styles.text}>
                    <div>
                        <p>코모(주) I 대표이사 코스모 I 사업자 등록 번호 I xxx-xx-xxxxx I 통신판매업 신고번호 2024-서울가산-xxxx호 I 서울 금천</p>
                        <p>구 가산디지털 2로 101 한라원앤원타워 B동 3층 306호 I 메일주소 kosmo147@kosmo.com</p>
                    </div>
                    <div>
                        <p>일부 상품의 경우, KOMO FUNDING은 통신판매중개자로서 거래 책임은 판매자에게 있습니다. 사이트 내 정보의 무단 복제,</p>
                        <p>전송, 배포, 크롤링, 스크래핑 등은 관련 법령에 의해 금지됩니다.</p>
                    </div>
                    <div>
                        <p>KOMO FUNDING은 플랫폼 제공자로서 프로젝트의 당사자가 아니며, 직접적인 통신판매를 진행하지 않습니다. 프로젝트의 완</p>
                        <p>수와 선물 제공에 대한 책임은 창작자에게 있으며, 후원자와의 법적 분쟁 책임 또한 창작자에게 있습니다.</p>
                    </div>
                </div>
            </div>
